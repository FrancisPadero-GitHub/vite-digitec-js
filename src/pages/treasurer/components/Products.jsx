...
function Products({
  ...
  if (isError) {
    return (
      <div>
        <div className="mt-3 p-3 sm:p-4 bg-red-50 rounded-lg border border-red-200">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
      {data.map((product, index) => (
        ...
        >
          ...
          <h2 className="text-xs sm:text-sm font-semibold text-base-content/70 mb-3">Loan Terms & Conditions</h2>
          <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 sm:gap-y-2 text-xs sm:text-sm">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-2">
              <span className="text-base-content/70 whitespace-nowrap">Loan Entitlement:</span>
