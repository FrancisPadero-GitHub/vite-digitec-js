...
export default function CoopShareCapitalReceiptModal({
  open,
  onClose,
  contribution,
}) {
  ...
  const displayData = {
    receiptNo: receipt_no || `CSC-${coop_contri_id}`,
    memberName: full_name || "System",
  ...
  const handlePdf = () => {
    ...
    doc.text("Coop Share Capital Receipt", 210, yPos, { align: "center" });
    yPos += lineHeight * 1.5;
    ...
    doc.setFontSize(10);
    doc.text(
      `Date: ${dayjs(displayData.contributionDate).format("MMMM DD, YYYY")}`,
      40,
      yPos
    );
    yPos += lineHeight;
    ...
    doc.save(`CoopShareCapital_Receipt_${displayData.receiptNo}.pdf`);
  };
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900">
                  {dayjs(displayData.contributionDate).format("MMMM DD, YYYY")}
                </span>
              </div>
              <div className="flex justify-between">
...
CoopShareCapitalReceiptModal.propTypes = {
  ...
  contribution: PropTypes.shape({
    ...
    coop_contri_id: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  }),
};
