        ...
        <div className="card bg-base-100 shadow-lg border border-base-300">
          <div className="card-body">
            ...
            <p className="text-sm text-base-content/70 mb-4">
              Create a login for a member, treasurer, or admin. Temporary passwords can be changed after login.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <label className="label text-sm font-semibold mb-2">Member Account</label>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      <AccountCircleIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/60 z-10" fontSize="inherit" />
                      <Combobox
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  <EmailOutlinedIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/60 z-10" fontSize="inherit" />
                  <Controller
                    name="email"
                    control={control}
                    rules={{
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  <LockOutlinedIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/60 z-10" fontSize="inherit" />
                  <Controller
                    name="password"
                    control={control}
                    rules={{
                  ...
                  >
                    {showPassword ? <VisibilityOffOutlinedIcon fontSize="medium" /> : <VisibilityOutlinedIcon fontSize="medium" />}
                  </button>
                </div>
              ...
              <div className="form-control">
                ...
                <label className="label">
                  <span className="text-xs label-text-alt text-base-content/60">User can change this after login.</span>
                </label>
              </div>
